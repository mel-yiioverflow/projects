...
$app->match('/attendance/create', function () use ($app) {
    ...
    if("POST" == $app['request']->getMethod()){
        ...
        if ($form->isValid()) {
            ...
            $app['db']->executeUpdate($update_query, array($data['date_time'], $data['employee_id'], 1490682711, 1490682711));            
...
$app->match('/attendance/edit/{id}', function ($id) use ($app) {
    ...
    if("POST" == $app['request']->getMethod()){
        ...
        if ($form->isValid()) {
            ...
            $app['db']->executeUpdate($update_query, array($data['date_time'], $data['employee_id'], $data['created_at'], 1490682711, $id));            
