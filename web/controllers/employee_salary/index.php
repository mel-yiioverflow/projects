...
$app->match('/employee_salary/create', function () use ($app) {
    ...
    if("POST" == $app['request']->getMethod()){
        ...
        if ($form->isValid()) {
            ...
            $app['db']->executeUpdate($update_query, array($data['employee_id'], $data['expense_id'], 1490178417, 1490178417));            
...
$app->match('/employee_salary/edit/{id}', function ($id) use ($app) {
    ...
    if("POST" == $app['request']->getMethod()){
        ...
        if ($form->isValid()) {
            ...
            $app['db']->executeUpdate($update_query, array($data['employee_id'], $data['expense_id'], $data['created_at'], 1490178417, $id));            
